...
class BlogController extends Controller
{
    ...
    public function tech_web_blogs_store(Request $request)
    {
        if ($request->hasFile('main_image')) {
            ...
            Image::make($main_image)->resize(360, 255)->save('backend/blogs/main_image/' . $main_image_name);
        ...
        if ($request->hasFile('banner_image')) {
            ...
            Image::make($banner_image)->resize(1920, 466)->save('backend/blogs/banner_image/' . $banner_image_name);
        ...
        if ($request->hasFile('details_image1')) {
            ...
            Image::make($details_image1)->resize(870, 460)->save('backend/blogs/details_images/' . $details_image1_name);
        ...
        if ($request->hasFile('details_image2')) {
            ...
            Image::make($details_image2)->resize(870, 460)->save('backend/blogs/details_images/' . $details_image2_name);
        ...
        if ($request->hasFile('details_image3')) {
            ...
            Image::make($details_image3)->resize(870, 460)->save('backend/blogs/details_images/' . $details_image3_name);
