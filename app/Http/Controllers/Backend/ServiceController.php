...
class ServiceController extends Controller
{
    ...
    public function tech_web_service_store(Request $request)
    {
        ...
        if ($request->hasFile('main_image')) {
            ...
            Image::make($main_image)->resize(300, 250)->save('backend/service/main_image/' . $main_image_name);
        ...
        if ($request->hasFile('banner_image')) {
            ...
            Image::make($banner_image)->resize(1920, 920)->save('backend/service/banner_image/' . $banner_image_name);
        ...
        if ($request->hasFile('detais_image_1')) {
            ...
            Image::make($detais_image_1)->resize(870, 370)->save('backend/service/details_images/' . $detais_image_1_name);
        ...
        if ($request->hasFile('detais_image_2')) {
            ...
            Image::make($detais_image_2)->resize(870, 370)->save('backend/service/details_images/' . $detais_image_2_name);
        ...
        if ($request->hasFile('detais_image_3')) {
            ...
            Image::make($detais_image_3)->resize(870, 370)->save('backend/service/details_images/' . $detais_image_3_name);
    ...
    public function tech_web_social_work_details($id){
        $banner = BannerAndTitle::where('status',1)->where('page','service')->first();
        $work_detials = Service::findOrFail($id);
        // dd($service);
        return view('frontend.social_work.social_work_details',compact('work_detials','banner'));
    }//end method---------------------------------------------
