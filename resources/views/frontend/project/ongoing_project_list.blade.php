...
@section('content')
    ...
    <div class="project-hero" style="background-image:url('{{ asset($banner->banner_image ?? '') }}');">
        ...
        <div class="container hero-content text-center">
            <span
                style="background:#0d6efd;color:#fff;font-size:.75rem;font-weight:700;letter-spacing:1px;text-transform:uppercase;padding:5px 16px;border-radius:50px;display:inline-block;margin-bottom:12px;"><i
                    class="mdi mdi-loading mdi-spin me-1"></i> Ongoing Projects</span>
            <h1 class="text-white fw-bold mb-2" style="font-size:clamp(1.6rem,4vw,2.5rem);">Currently Under Construction</h1>
            <p class="text-white-50 mb-0">Explore our active residential &amp; commercial projects in progress</p>
            <div class="section-divider"></div>
        </div>
    </div>

    <section class="py-5" style="background:#f5f8ff;">
        <div class="container">

            <div class="search-card mb-5">
                <p class="fw-semibold text-primary mb-3"><i class="mdi mdi-home-search me-1"></i> Filter Ongoing Properties
                </p>
                <form action="{{ route('ongoing.project.search') }}" method="get">
                    <div class="row g-3 align-items-end">
                        ...
                        @php $property = App\Models\Project::where('property_status',1)->get(); @endphp
                        <div class="col-md-4">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="prop-card">
                            <div class="prop-img-wrap">
                                ...
                                <span class="prop-badge-ongoing"><i class="mdi mdi-clock-outline me-1"></i>Ongoing</span>
                            </div>
                            <div class="prop-body">
                                <a href="{{ route('completed.project.details', $item->id) }}"
                                    class="prop-title">{{ $item->property_name }}</a>
                                <p class="prop-location"><i
                                        class="mdi mdi-map-marker text-primary me-1"></i>{{ $item->location_eng }}</p>
                                ...
                                <div class="prop-actions">
                                    ...
                                    <a href="{{ route('completed.project.details', $item->id) }}" class="btn btn-primary">
