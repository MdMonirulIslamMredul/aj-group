...
<!-- Hero End -->
 ...
 <div class="container-fluid mt-100 mt-60 mb-100 mb-60 pb-5" >
    <div class="row justify-content-center">
        <div class="col">
            <div class="section-title text-center mb-4 pb-2">
                ...
                <p class="text-muted para-desc mb-0 py-3 mx-auto">Step into the realm of luxury living and unparalleled convenience as we showcase our exceptional apartment and land projects in and around Dhaka. From stunning urban residences to expansive plots of land ripe for development, our projects epitomize modern living at its finest. Discover the perfect blend of comfort, style, and sophistication, meticulously crafted to exceed your expectations/p>
            </div>
        </div><!--end col-->
    </div><!--end row-->
       ...
       <div class="col-lg-4 col-md-4 col-12">
                        <div class="card property border-0 shadow position-relative overflow-hidden rounded-3">
                            <div class="property-image position-relative overflow-hidden shadow">
                                <img src="{{ asset($item->property_thumbnail ?? null ) }}" class="img-fluid" alt="Image" style="width: 100%;height:300px">
                                
                            </div>

                            <div class="card-body content p-4" style="
    height: 273px;
">
                                ...
                                <ul class="list-unstyled mt-3 py-3 border-top border-bottom d-flex align-items-center justify-content-between">
                                    <li class="d-flex align-items-center me-3">
                                        ...
                                        <span class="text-muted">{{ $item->property_size  }} SQFT</span>
                                ...
                                <ul class="list-unstyled d-flex justify-content-between mt-2 mb-0">
                                    <li class="list-inline-item mb-0">
                                        ...
                                        <span class="fw-mediumtext-muted" >Offer Price: &#2547; {{ $item->discount }}</span>
                                        <p class="fw-medium mb-0" style="font-size: smaller;">Regular Price: &#2547; <del>{{ $item->price }}</del></p>
                                    </li>
                  
                                    <li class="list-inline-item mb-0 mt-3">
                                        <a href="tel:{{ App\Models\WebsiteLink::latest()->first()->phone }}" class="btn btn-sm btn-primary" style="font-size: 14px">Call</a>
