...
@section('title') Upcomming Project @endsection
@section('content')
        ...
        <div class="row mt-5 justify-content-center">
            <div class="col-12">
                <div class="title-heading text-center">                   
                    <h5 class="heading fw-semibold mb-0 sub-heading text-white title-dark">Upcomming Project</h5>
                </div>
            </div><!--end col-->
        </div><!--end row-->
        ...
        <div class="row justify-content-center">
            <div class="col">
                <div class="section-title text-center mb-4 pb-2">
                    <h4 class="title text-primary mb-3 ">Upcomming Procject</h4>
