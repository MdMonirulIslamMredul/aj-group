...
<form id="myForm" method="post" action="{{ route('social.work.store') }}" enctype="multipart/form-data">
    @csrf
    <div class="row">                  
        <div class="col-lg-12">                      
        ...
        <div class="col-lg-2"> 
            ...
            <img src="{{ url('upload/no_image.jpg') }}" alt="" id="details_image4_show" class="avatar-lg img-thumbnail" alt="profile-image" style="width: 120px;height:120px">
        </div> 

        <div class="col-lg-12 mt-2"> 
            <div class="form-group mb-3">
                <label for="example-email" class="form-label">Work Short Description</label>              
                <textarea id="tinymce" class="editor form-control" col="10" row="15" name="short_des_eng"></textarea>     
            </div>
        </div> 
