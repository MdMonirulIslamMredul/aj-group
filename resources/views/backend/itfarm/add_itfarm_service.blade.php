        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Add IT Service</h4>
                </div>
            </div>
        </div>     
        <!-- end page title --> 
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form id="myForm" method="post" action="{{ route('it_service.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">                  
                                <div class="col-lg-12">                      
                                    <div class="form-group mb-3">
                                        <label for="it_service_name_eng" class="form-label">IT Service Name English </label>
                                        <input type="text" name="it_service_name_eng" id="it_service_name_eng" class="form-control" placeholder="IT Service Name English...">
                                ...
                                <div class="col-lg-12 mt-2">                                    
                                    <div class="form-group">
                                        ...
                                        <textarea id="tinymce" class="editor form-control" col="10" row="15" name="long_des_eng" id="long_des_eng" placeholder="IT Service Long Description Englsh..."></textarea>                                     
                                    </div>                                      
                                </div>  
