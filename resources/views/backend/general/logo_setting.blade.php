               ...
               @endphp
                <form id="myForm" method="post" action="{{ route('logo.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row">                  
                        ...
                        <div class="col-lg-12"> 
                            <div class="form-group mb-3">
                                <label for="banner_image" class="form-label">Login Background Image(1920X930)</label>
                                <input type="file" id="login_bk_img" name="login_bk_img" class="form-control">
                            </div>
                            @if($logo->login_bk_img??null)
                            <img src="{{ asset( $logo->login_bk_img??null ) }}" alt="" id="login_bk_showImg" class="avatar-lg img-thumbnail" alt="profile-image" style="width: 300px;height:100px">
                            @else
                            <img src="{{ url('upload/no_image.jpg') }}" alt="" id="login_bk_showImg" class="avatar-lg img-thumbnail" alt="profile-image" style="width: 300px;height:100px">
                            @endif
                        </div> 
...
<script>
    $(document).ready(function(){
        ...
        $('#login_bk_img').change(function(e){
            var reader = new FileReader();
            reader.onload = function(e){
                $('#login_bk_showImg').attr('src',e.target.result);
            }
            reader.readAsDataURL(e.target.files['0']);
        });       
    });
