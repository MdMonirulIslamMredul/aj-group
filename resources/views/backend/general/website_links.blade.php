            ...
            <div class="card-body">
                ...
                <form id="myForm" method="post" action="{{ route('websitelink.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row">                  
                        ...
                        <div class="col-lg-6"> 
                            <div class="form-group mb-3">
                                <label for="example-email" class="form-label">Phone 2 </label>
                                <input type="text" name="phone_2" id="phone_2" class="form-control" placeholder="Phone..." value="{{ $website->phone_2??'' }}">
                            </div>
                        </div> 
                        <div class="col-lg-6"> 
                            <div class="form-group mb-3">
                                <label for="example-email" class="form-label">Phone 3 </label>
                                <input type="text" name="phone_3" id="phone_3" class="form-control" placeholder="Phone..." value="{{ $website->phone_3??'' }}">
                            </div>
                        </div> 
                        <div class="col-lg-6">                      
                            <div class="form-group mb-3">
