            ...
            <div class="card-body">                
                ...
                <form id="myForm" method="post" action="{{ route('banner.title.update') }}" enctype="multipart/form-data">
                    ...
                    <div class="row">                  
                        ...
                        <div class="col-lg-6"> 
                            <div class="form-group mb-3">
                                <label for="banner_image" class="form-label">Banner Image(1920x466)</label>
...
<div class="col-lg-6 mt-1"> 
    ...
    <label for="example-select" class="form-label">Select Page for the title and banner</label>
        <select class="form-select" name="page" id="page" style="padding:12px 5px">
            <option value="" disabled selected>Select Page</option>
            <option value="courses" {{ $edit_banner_title->page == 'courses' ? 'selected' : '' }}>project</option>
            <option value="service" {{ $edit_banner_title->page == 'service' ? 'selected' : '' }}>Service</option>
            ...
            <option value="team" {{ $edit_banner_title->page == 'team' ? 'selected' : '' }}>Team</option>
            <option value="event" {{ $edit_banner_title->page == 'event' ? 'selected' : '' }}>Event</option>
            ...
            <option value="agro" {{ $edit_banner_title->page == 'agro' ? 'selected' : '' }}>Agro Product</option>
             <option value="certificate" {{ $edit_banner_title->page == 'certificate' ? 'selected' : '' }}>certificate</option>
                                    <option value="media" {{ $edit_banner_title->page == 'media' ? 'selected' : '' }}>media</option>
                                    <option value="social_respon" {{ $edit_banner_title->page == 'social_respon' ? 'selected' : '' }}>Social Responsibility</option>
        </select>
    </div>
</div>  <!-- end col --> 
                    </div>
