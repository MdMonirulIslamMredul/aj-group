                    ...
                    <div class="card-body">
                       ...
                       <p class="text-white" style="font-size: 20px">Edit Team Members Information</p>
                        ...
                        <form id="myForm" method="post" action="{{ route('update.team') }}" enctype="multipart/form-data">
                            ...
                            <select name="committee" class="form-select" id="committee" style="padding:12px 5px;">
                                <option selected disabled>Select Team Type</option>
                                <option value="1" {{ $edit_team->committee == '1' ? 'selected' : '' }}>1</option>
                                <option value="2" {{ $edit_team->committee == '2' ? 'selected' : '' }}>2</option>
                                <option value="3" {{ $edit_team->committee == '3' ? 'selected' : '' }}>3</option>                               
                                <option value="4" {{ $edit_team->committee == '4' ? 'selected' : '' }}>4</option>
                                <option value="5" {{ $edit_team->committee == '5' ? 'selected' : '' }}>5</option>
                                <option value="6" {{ $edit_team->committee == '6' ? 'selected' : '' }}>6</option>
                                <option value="7" {{ $edit_team->committee == '7' ? 'selected' : '' }}>7</option>
                                <option value="8" {{ $edit_team->committee == '8' ? 'selected' : '' }}>8</option>
