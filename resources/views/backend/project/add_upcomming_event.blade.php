                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <a href="{{ route('all.upcomming.events') }}" class="btn btn-primary rounded-pill waves-effect waves-light"><i class="fe-arrow-left"></i>All Upcomming Events</a>                            
                        </ol>
                    </div>
                    <h4 class="page-title">Add Upcomming Events</h4>
                </div>
            </div>
        </div>     
        <!-- end page title --> 
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form id="myForm" method="post" action="{{ route('upcomming.event.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">                  
                                <div class="col-lg-12">                      
