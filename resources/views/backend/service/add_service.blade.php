            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                       ...
                       <p class="text-white" style="font-size: 20px">Services Main Informantion</p>
                            ...
                            <div class="row">                  
                                <div class="col-lg-6">                      
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="title_english" id="title_english" class="form-control" placeholder="Service Title In English...">
                                    </div>
                                </div>    
                                <div class="col-lg-6"> 
                                    <div class="form-group mb-3">
                                        <label for="example-email" class="form-label">Service Title In Bangla </label>
                                        <input type="text" id="title_bangla" name="title_bangla" class="form-control" placeholder="Service Title In Bangla ...">
                                    </div>
                                </div> 
                                <div class="col-lg-6"> 
                                    <div class="form-group mb-3">
                                ...
                                <div class="col-lg-6"> 
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" id="price" name="price" class="form-control" placeholder="Course Price ...">
                                    </div>
                                </div> 
