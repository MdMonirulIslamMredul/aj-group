                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <a href="{{ route('all.services') }}" class="btn btn-primary rounded-pill waves-effect waves-light"><i class="fe-arrow-left"></i>All Service</a>                            
                        </ol>
                    </div>
                    ...
                    <div class="card-body">
                       ...
                       <p class="text-white" style="font-size: 20px">Edit Services</p>
                        ...
                        <form id="myForm" method="post" action="{{ route('update.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row">                  
                                <div class="col-lg-6">                      
                                    <div class="form-group mb-3">
                                        ...
                                        value="{{ $edit_service->title_english??null }}" >
                                    </div>
                                </div>    
                                <div class="col-lg-6"> 
                                    <div class="form-group mb-3">
                                        <label for="example-email" class="form-label">Service Title In Bangla </label>
                                        <input type="text" id="title_bangla" name="title_bangla" class="form-control" value="{{ $edit_service->title_bangla??null }}">
                                    </div>
                                </div> 
                                <div class="col-lg-6"> 
                                    <div class="form-group mb-3">
                                    ...
                                    <img src="{{ asset($edit_service->main_image) }}" alt="" id="main_image_show" class="avatar-lg img-thumbnail" alt="profile-image" style="width: 120px;height:120px">
                                    @else
                                ...
                                <div class="col-lg-6"> 
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" id="price" name="price" class="form-control" value="{{ $edit_service->price }}">
                                    </div>
                                </div> 
                                <div class="col-lg-6 mt-2"> 
                                    <div class="form-group mb-3">
                                        <label for="example-email" class="form-label">Service Short Description in English </label>
                                        <textarea name="des_sm_eng" class="form-control" id="" cols="30" rows="5" placeholder="Service Short Description English ...">
                                ...
                                <div class="col-lg-6 mt-2"> 
                                    <div class="form-group mb-3">
                                        <label for="example-email" class="form-label">Service Short Description in Bangla </label>
                                        <textarea name="des_sm_bng" class="form-control" id="" cols="30" rows="5" placeholder="Service Short Description Bangla ...">
                                ...
                                <div class="col-lg-6"> 
                                    ...
                                    <img src="{{ asset($edit_service->banner_image) }}" alt="" id="banner_image_show" class="avatar-lg img-thumbnail" alt="profile-image" style="width: 120px;height:120px">
                                    @else
                                ...
                                <div class="col-lg-6"> 
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="file" id="detais_image_1" name="detais_image_1" class="form-control" >
                                    </div>
                                    @if($edit_service->detais_image_1)
                                    <img src="{{ asset($edit_service->detais_image_1) }}" alt="" id="detais_image_1_show" class="avatar-lg img-thumbnail" alt="profile-image" style="width: 120px;height:120px">
                                    @else
                                    <img src="{{ url('upload/no_image.jpg') }}" alt="" id="detais_image_1_show" class="avatar-lg img-thumbnail" alt="profile-image" style="width: 120px;height:120px">
                                    @endif                                     
                                </div>  
                                <div class="col-lg-6 mt-2"> 
                                    <div class="form-group mb-3">
                                        <label for="detais_image_2" class="form-label">Details Image 2</label>
                                        <input type="file" id="detais_image_2" name="detais_image_2" class="form-control" >
                                    </div>
                                    @if($edit_service->detais_image_2)
                                    <img src="{{ asset($edit_service->detais_image_2) }}" alt="" id="detais_image_2_show" class="avatar-lg img-thumbnail" alt="profile-image" style="width: 120px;height:120px">
                                    @else
                                ...
                                <div class="col-lg-6 mt-2"> 
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="file" id="detais_image_3" name="detais_image_3" class="form-control" >
                                    </div>
                                    @if($edit_service->detais_image_3)
                                    <img src="{{ asset($edit_service->detais_image_3) }}" alt="" id="detais_image_3_show" class="avatar-lg img-thumbnail" alt="profile-image" style="width: 120px;height:120px">
                                    @else
                                ...
                                <div class="col-lg-12 mt-2">                                    
                                        <div class="form-group">
                                            <label for="long_des1_eng" class="form-label">Service Long Details-1 English</label>                                            
                                ...
                                <div class="col-lg-12 mt-2"> 
                                    <div class="form-group mb-3">
                                        <label for="long_des1_bng" class="form-label">Service Long Details-1 Bangla</label>
                                ...
                                <div class="col-lg-12 mt-2">                                    
                                    <div class="form-group">
                                        <label for="long_des2_eng" class="form-label">Service Long Details-2 English</label>
                            ...
                            <div class="col-lg-12 mt-2"> 
                                <div class="form-group mb-3">
                                    <label for="long_des2_bng" class="form-label">Service Long Details-2 Bangla</label>
                            ...
                            <div class="col-lg-12 mt-2">                                    
                                <div class="form-group">
                                    <label for="long_des3_eng" class="form-label">Service Long Details-3 English</label>
                                    <textarea name="long_des3_eng" id="tinymce" class="editor form-control" cols="30" rows="15" placeholder="Service Long Details-3 English ...">
                        ...
                        <div class="col-lg-12 mt-2"> 
                            <div class="form-group mb-3">
                                <label for="long_des3_bng" class="form-label">Service Long Details-3 Bangla</label>
